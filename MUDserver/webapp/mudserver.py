from flask import Flask #importing flask and send-file packages
...
def downloadFile (name):#function that fetches and sends the desired MUD files to the controller
